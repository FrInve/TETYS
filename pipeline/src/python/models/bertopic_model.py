...
def create_model():
    ...
    hdbscan_model = HDBSCAN(min_cluster_size=100, min_samples=10, metric='euclidean', cluster_selection_method='leaf', prediction_data=True)
...
if __name__ == '__main__':
    ...
    topic_model.save('./models/BERTopic_full_2023-04-18', save_embedding_model=False)
